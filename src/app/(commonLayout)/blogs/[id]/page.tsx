...
export async function generateStaticParams() {
  ...
  // return blogs.map((blog: Blog) => ({ id: blog.id }));

  // We can define how many blogs we want to statically generate with splice
  return blogs.map((blog: Blog) => ({ id: blog.id })).splice(0, 3);
}
